...
public class DiscordPresence {
    ...
    public static void start() {
        ...
        rpc.Discord_Initialize("924380694766059560", handlers, true, "");
        ...
        DiscordPresence.presence.largeImageKey = "atriumlogo";
        DiscordPresence.presence.largeImageText = "Atrium v1.5.6";
