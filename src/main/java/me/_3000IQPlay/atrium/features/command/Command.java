package me._3000IQPlay.atrium.features.command;
...
public abstract class Command
    ...
    public static void sendMessage(String message, boolean notification) {
        Command.sendSilentMessage(Atrium.commandManager.getClientMessage() + " " + "\u00a7r" + message);
        if (notification) {
            Atrium.notificationManager.addNotification(message, 3000L);
        }
    }
    ...
    public static String getCommandPrefix() {
        return Atrium.commandManager.getPrefix();
    }
