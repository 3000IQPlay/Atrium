...
import me._3000IQPlay.atrium.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Atrium.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module : Atrium.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Atrium.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Atrium.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
