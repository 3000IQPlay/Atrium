...
public class Chams
    ...
    public Setting<Integer> hiddenRed = this.register(new Setting<Object>("Hidden Red", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.colored.getValue() != false && this.xqz.getValue() != false && this.rainbow.getValue() == false));
    public Setting<Integer> hiddenGreen = this.register(new Setting<Object>("Hidden Green", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> this.colored.getValue() != false && this.xqz.getValue() != false && this.rainbow.getValue() == false));
