...
public class CrystalModify
    ...
    public Setting<Integer> enchantRed = this.register(new Setting<Object>("Glint Red", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.enchanted.getValue()));
    ...
    public Setting<Integer> red = this.register(new Setting<Integer>("Red", 190, 0, 255));
    ...
    public Setting<Integer> outlineRed = this.register(new Setting<Object>("Outline Red", Integer.valueOf(190), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue()));
    ...
    public Setting<Integer> hiddenRed = this.register(new Setting<Object>("Hidden Red", Integer.valueOf(190), Integer.valueOf(0), Integer.valueOf(255), v -> this.hiddenSync.getValue() == false));
