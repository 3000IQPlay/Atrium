...
public class AutoArmor
    ...
    public void onTick() {
        ...
        if (this.timer.passedMs((int) ((float) this.delay.getValue().intValue() * Atrium.serverManager.getTpsFactor()))) {
            if (!this.taskList.isEmpty()) {
