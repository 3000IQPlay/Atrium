...
import me._3000IQPlay.atrium.mixin.mixins.accessors.IContainer;
import me._3000IQPlay.atrium.mixin.mixins.accessors.ISPacketSetSlot;
...
public class Offhand
    ...
    private boolean noNearbyPlayers() {
        return this.mode == Mode.CRYSTALS && Offhand.mc.world.playerEntities.stream().noneMatch(e -> e != Offhand.mc.player && !Atrium.friendManager.isFriend(e) && Offhand.mc.player.getDistance(e) <= this.cTargetDistance.getValue().floatValue());
    }
