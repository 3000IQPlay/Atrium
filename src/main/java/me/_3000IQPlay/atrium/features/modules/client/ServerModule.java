...
import me._3000IQPlay.atrium.mixin.mixins.accessors.IC00Handshake;
...
public class ServerModule
    ...
    public Setting<String> ip = this.register(new Setting<String>("AtriumIP", "0.0.0.0.0"));
    ...
    public ServerModule() {
        super("PingBypass", "Manages Atrium`s internal Server", Module.Category.CLIENT, false, false, true);
        instance = this;
    }
