...
import me._3000IQPlay.atrium.features.modules.client.Notifications;
import me._3000IQPlay.atrium.features.modules.client.ModuleTools;
...
public class TotemPopManager
        ...
        if (this.getTotemPops(player) == 1) {
            if (ModuleTools.getInstance().isEnabled()) {
                switch (ModuleTools.getInstance().popNotifier.getValue()) {
                    ...
                    case ATRIUM: {
                        String text = ChatFormatting.AQUA + player.getName() + ChatFormatting.WHITE + " popped " + ChatFormatting.AQUA + this.getTotemPops(player) + ChatFormatting.WHITE + " totem.";
                        return text;
                    }
                    case DOTGOD: {
                    ...
                    case NONE: {
                        return Atrium.commandManager.getClientMessage() + ChatFormatting.WHITE + player.getName() + " popped " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totem.";
                    }
                }
            } else {
                return Atrium.commandManager.getClientMessage() + ChatFormatting.WHITE + player.getName() + " popped " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totem.";
            ...
            if (ModuleTools.getInstance().isEnabled()) {
                switch (ModuleTools.getInstance().popNotifier.getValue()) {
                    ...
                    case ATRIUM: {
                        String text = ChatFormatting.AQUA + player.getName() + ChatFormatting.WHITE + " popped " + ChatFormatting.AQUA + this.getTotemPops(player) + ChatFormatting.WHITE + " totems.";
                        return text;
                    }
                    case DOTGOD: {
                ...
                return Atrium.commandManager.getClientMessage() + ChatFormatting.WHITE + player.getName() + " popped " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totems.";
            }
        }
        return "";
    }
    ...
    public void init() {
        this.notifications = Atrium.moduleManager.getModuleByClass(Notifications.class);
    }
        ...
        if (this.getTotemPops(player) == 1) {
            if (ModuleTools.getInstance().isEnabled()) {
                switch (ModuleTools.getInstance().popNotifier.getValue()) {
                    ...
                    case ATRIUM: {
                        String text = ChatFormatting.AQUA + player.getName() + ChatFormatting.WHITE + " died after popping " + ChatFormatting.AQUA + this.getTotemPops(player) + ChatFormatting.WHITE + " totem.";
                        return text;
                    }
                    case DOTGOD: {
                    ...
                    case NONE: {
                        return Atrium.commandManager.getClientMessage() + ChatFormatting.WHITE + player.getName() + " died after popping " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totem!";
            ...
            if (ModuleTools.getInstance().isEnabled()) {
                switch (ModuleTools.getInstance().popNotifier.getValue()) {
                    ...
                    case ATRIUM: {
                        String text = ChatFormatting.AQUA + player.getName() + ChatFormatting.WHITE + " died after popping " + ChatFormatting.AQUA + this.getTotemPops(player) + ChatFormatting.WHITE + " totems.";
                        return text;
                    }
                    case DOTGOD: {
                    ...
                    case NONE: {
                        return Atrium.commandManager.getClientMessage() + ChatFormatting.WHITE + player.getName() + " died after popping " + ChatFormatting.GREEN + this.getTotemPops(player) + ChatFormatting.WHITE + " Totems!";
